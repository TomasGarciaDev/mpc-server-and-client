...
server.tool("create-ramdom-user", "Create a random user with fake data", {
            ...
            messages: [
                {
                    ...
                    content: {
                        type: "text",
                        text: "Generate a fake user data. The user should have a realistic name, email, address, and phone number. Return this data as a JSON object with no other text or formatter so it can be used with JSON.parse().",
                    },
                },
            ],
            maxTokens: 1024,
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: `User ${id} created succesfully` }],
        };
    }
    catch {
        return {
